...
Failide arvu - mitu faili soovitakse luua.

Eesliidet - failinime algus (valikuline).

Sihtkausta - asukoht, kuhu failid salvestatakse (vaikimisi soovitab C:\Temp\files).
